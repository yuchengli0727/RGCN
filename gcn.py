...
class GCN(nn.Module):
    ...
    def forward(self, data, device):
        ...
        output_1 = self.linear_1(torch.matmul(graph_data, flow_x))  # [B, N, hid_C]
        output_1 = self.act(output_1)  # [N, N], [B, N, Hid_C]

        output_2 = self.linear_2(torch.matmul(graph_data, output_1))
        output_2 = self.act(output_2)  # [B, N, 1, Out_C] -- [64, 307, 6]

        output_3 = self.linear_2(torch.matmul(graph_data, output_2))
        output_3 = self.act(output_3)  # [B, N, 1, Out_C] -- [64, 307, 6]
